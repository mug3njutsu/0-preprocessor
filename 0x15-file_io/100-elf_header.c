...
/**
 * elf_entry - print &entry_point
 * @buffer: str containing &entry_point
 * @bit_mode: bit mode (32 || 64)
 * @big_endian: endianness (big endian if non-zero)
 */
...
/**
 * main - cp file's contents to another file
 * @argc: the arg count
 * @argv: the arg values
